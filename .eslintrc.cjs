...
module.exports = {
  ...
  rules: {
    ...
    'dot-notation': 'off',
    // @fixable 必须使用 === 或 !==，禁止使用 == 或 !=，与 null、undefined 比较时除外
    eqeqeq: ['error', 'smart'],
    ...
    // 禁止使用逗号操作符
    'no-sequences': 'error',
    // 尽量不要 throw 字面量， throw 一个 Error 对象
